...
%token <wchar> CHAR
%token <token> RETURN FOR IF ELSE BREAK AND OR EQUAL VOID
%token <token> NEQUAL TRUE FALSE LE GE CONTINUE
...
%type <stmt> stmt simple_stmt var_assi return_stmt
...
%type <expr> for_cond expr numeric bool
